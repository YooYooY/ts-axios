import { parseHeaders, processHeaders, flattenHeader } from '../../src/helpers/headers'
    ...
    test('should parse headers', () => {
      const parsed = parseHeaders(
        'Content-Type: application/json\r\n' +
          ...
          'Date: Tue, 21 JUNE 2020 09:23:44 GMT\r\n' +
          ':aa\r\n' +
          'key:'
      )
      ...
      expect(parsed['date']).toBe('Tue, 21 JUNE 2020 09:23:44 GMT')
  ...
  describe('flattenHeaders', () => {
    test('should flatten the headers and include common headers', () => {
      const headers = {
        ...
        post: {
          'X-POST-HEADER': 'posdtHeaderValue'
        }
      }
    ...
    test('should flatten the headers without common headers', () => {
      ...
      expect(flattenHeader(headers, 'patch')).toEqual({
        Accept: 'application/json'
      })
    })
